...
function executeChain (chain, ins, vars, callback) {
  ...
  function setVariable (name, val) {
    ...
    const script = '(() => {__proxy.' + name + ' = ' + scriptVal + '; this.__proxy = null; return this})()'
    safeEval = requireOnce('./safe-eval.js')
  ...
  function injectSpecialProperties (variables) {
    ...
    Object.defineProperty(variables.$, 'runChain', {
      get: () => {
        return variables._runChain
      }
    })
    Object.defineProperty(variables.$, 'map', {
      get: () => {
        return variables._map
      }
    })
    Object.defineProperty(variables.$, 'filter', {
      get: () => {
        return variables._filter
      }
    })
  }

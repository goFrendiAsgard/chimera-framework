...
function httpRequest (opts, callback) {
  ...
  request(opts, (error, response, body) => {
    ...
    let data = {body}
    if (!error) {
      for (let key of ['domain', 'statusCode', 'statusMessage', 'url', 'method', 'headers', 'trailers', 'rawHeaders', 'rawTrailers', 'complete', 'httpVersion', 'httpVersionMajor', 'httpVersionMinor']) {
